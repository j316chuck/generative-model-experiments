...
srun -N 1 python3 hmm_experiments.py --n_jobs 24 --hidden_size 200 --max_iterations 100000 --num_sequences 1000 --length 238 --name "hmm_trial_3" & 
srun -N 1 python3 hmm_experiments.py --n_jobs 24 --hidden_size 500 --max_iterations 100000 --num_sequences 1000 --length 238 --name "hmm_trial_4" & 
wait
